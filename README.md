...
- ✅ Installs common CLI tools: `neovim`, `curl`, `nano`, `git`, `htop`, `zsh`
- ✅ Installs zinit
- ✅ Installs Oh My Posh
...
2. Installs zinit as main zsh plugin manager
3. Installs Oh My Posh (if not present).
...
- **Oh My Posh already installed:** You’ll see a message and the installation will be skipped; existing configs are left intact.
